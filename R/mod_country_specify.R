  ...
  moduleServer( id, function(input, output, session){
    ...
    output$download_shp_instruction <- renderUI({
      ...
      upload_instruct_text <- HTML(paste0(
        ...
        "<li>",
        "Go to the <a href='https://gis-who.hub.arcgis.com/pages/detailedboundary' target='_blank'>detailed boundary files section</a>",
        ...
        "<li>",
        "<strong>Detailed Boundary ADM1</strong>",
        "</li>",
        "<li>",
        "<strong>Detailed Boundary ADM2</strong>",
        "</li>",
        "</ul>",
        "Steps: Click on 'Explore' then download the 'Shapefile' format from the left tab.",
        "</li>",
        "<li>",
        "Once downloaded, the files will be in <strong>.zip format</strong>.",
        "</li>",
        "<li>",
