...
The RShiny app is readily accessible via [https://cernunosat90.cern.ch/](https://cernunosat90.cern.ch/). The only requirement is a stable internet connection. This web-based deployment supports full functionality and serves as the primary distribution channel.
