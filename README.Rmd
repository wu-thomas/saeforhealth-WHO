...
The RShiny application is readily accessible via [https://rsc.stat.washington.edu/saeforhealth](https://rsc.stat.washington.edu/saeforhealth). The only requirement is a stable internet connection. This web-based deployment supports full functionality and serves as the primary distribution channel.
...
You can launch the Shiny app with the following command, and we recommend opening a new browser tab from within the launched shiny app for better accessing web links.
