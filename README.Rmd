...
The RShiny app is readily accessible via [https://rsc.stat.washington.edu/saeforhealth/](https://rsc.stat.washington.edu/saeforhealth/). The only requirement is a stable internet connection. This web-based deployment supports full functionality and serves as the primary distribution channel.
...
Our tool works exclusively for 2.12.0 version of the labelled package, so we make sure the correct version is used. 
