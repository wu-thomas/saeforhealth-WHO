...
##
golem::fill_desc(
  pkg_name = "saeforhealth", # The Name of the package containing the App
  pkg_title = "Small Area Estimation for Health Indicators", # The Title of the package containing the App
  ...
  repo_url = 'https://github.com/wu-thomas/saeforhealth-WHO', # The URL of the GitHub Repo (optional),
